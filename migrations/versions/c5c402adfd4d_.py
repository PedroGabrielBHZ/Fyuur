...
Revision ID: c5c402adfd4d
Revises: 
Create Date: 2022-01-11 21:41:36.547972
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['contact_id'], ['Contact.id'], name='Venue_contact_id_fkey'),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text('nextval(\'"Contact_id_seq"\'::regclass)'), autoincrement=True, nullable=False),
    ...
    sa.Column('genres', postgresql.ARRAY(sa.VARCHAR()), autoincrement=False, nullable=True),
    sa.Column('contact_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['contact_id'], ['Contact.id'], name='Artist_contact_id_fkey'),
